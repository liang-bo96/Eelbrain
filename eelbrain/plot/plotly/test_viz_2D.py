...
class TestEelbrainPlotly2DViz(unittest.TestCase):
    ...
    def _create_mock_ndvar(self, data, dims):
        ...
        if 'case' in dims:
            ...
            mock_mean_ndvar = self._create_mock_ndvar(mean_data, [d for d in dims if d != 'case'])
    ...
    def test_init_with_ndvar_vector_data(self, mock_dash):
        ...
        # Check data shapes
        self.assertEqual(viz.glass_brain_data.shape, (self.n_sources, self.n_space, self.n_times))
    ...
    def test_arrow_threshold_filtering(self, mock_dash):
        ...
        fig = viz._create_plotly_brain_projection('axial', test_coords, test_activity, 0.5)
        self.assertIsNotNone(fig)
...
class TestArrowThresholdFeature(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_ndvar = self._create_mock_ndvar(self.test_data, ['source', 'space', 'time'])
    ...
    def test_arrow_threshold_custom(self, mock_dash):
        ...
        threshold_value = 0.5
        viz = EelbrainPlotly2DViz(y=self.mock_ndvar, arrow_threshold=threshold_value)
