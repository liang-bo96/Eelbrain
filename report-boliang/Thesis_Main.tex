...
\afterpreface
  ...
  \include{chapter2_design_implementation}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}
        
  \include{chapter2_design_principles}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}
        
  \include{chapter3_code_review}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}

  \include{chapter5_usability}
...
\begin{appendix}
     \include{appendixA_new} % Usability Questionnaire
     \include{appendixSRS} % Software Requirements Specification
     \include{chapter4_contributor_guide} % Contributor Guidelines
\end{appendix}
